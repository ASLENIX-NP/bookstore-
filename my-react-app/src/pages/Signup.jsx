        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 px-4 text-white font-semibold rounded-xl transition-all duration-200 mt-2 shadow-sm flex items-center justify-center gap-2 ${
                loading
                  ? 'bg-gray-400 cursor-not-allowed'
                  : 'bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-500/20 cursor-pointer'
              }`}
            >
              {loading ? (
                <>
          ...
          <div className="space-y-3 text-center text-sm font-medium">
            ...
            <div className="pt-2">
              <Link
                to="/"
                className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-800 transition-colors font-semibold"
              >
                <ArrowLeft size={16} />
                Back to store
              </Link>
      ...
      <div className="hidden md:flex md:w-1/2 items-center justify-center p-12 relative overflow-hidden bg-gradient-to-tr from-purple-600 via-indigo-600 to-indigo-500">
        ...
        <div className="relative text-center max-w-md space-y-4 z-10">
          ...
          <p className="text-indigo-100 text-base lg:text-lg font-medium leading-relaxed opacity-90">
            Create an account today to get access to thousands of e-books,
            personalized recommendations, and member-only discounts.
          </p>
        </div>
      </div>
    </div>
