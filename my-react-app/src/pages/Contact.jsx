...
const defaultContactContent = {
  ...
  content:
    "Have a question about a book, magazine, stationery order, or availability? Send us your message and our team will respond as soon as possible.",
};
  ...
  useEffect(() => {
    const fetchContactContent = async () => {
      try {
        ...
        if (pageData.success && pageData.policy) {
          const pageContent = pageData.policy.content || "";

          const looksLikeFooterContact =
            pageContent.includes("Business Name:") ||
            pageContent.includes("PAN/VAT") ||
            pageContent.includes("Website:");

          setContactContent({
            title: pageData.policy.title || defaultContactContent.title,
            content: looksLikeFooterContact
              ? defaultContactContent.content
              : pageContent || defaultContactContent.content,
          });
        }

        if (detailsData.success && detailsData.policy?.content) {
          try {
            const parsedDetails = JSON.parse(detailsData.policy.content);
            ...
            console.error("Contact details parse error:", error);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-slate-300 mt-5 leading-relaxed">
              ...
              availability, or store information.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-[2rem] shadow-xl border border-gray-100">
              <div className="mb-8">
                ...
                <p className="text-gray-500 mt-2">
                  Fill the form below. Your message will appear inside admin
                  message section.
                </p>
              </div>
