    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-2 pb-20">
        ...
        <section className="relative bg-white rounded-[2rem] border border-gray-100 shadow-2xl overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
              ...
              {/* Price & CTA */}
              <div className="mt-8 bg-gradient-to-r from-slate-950 to-slate-900 text-white rounded-[1.7rem] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 shadow-2xl">
                <div>
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-2 px-7 py-4 rounded-2xl text-sm font-black transition-all ${
                    isOutOfStock
                      ...
                      : 'bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-900/20 hover:-translate-y-0.5'
                  }`}
                >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
            ...
            {!product.reviews || product.reviews.length === 0 ? (
              ...
              <div className="space-y-4">
                {[...product.reviews].reverse().map((review) => (
                  <div
                    key={review._id}
                    className="border border-gray-100 rounded-[1.5rem] p-5 bg-gradient-to-br from-slate-50 to-white hover:shadow-md transition-all"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-2xl bg-indigo-600 text-white flex items-center justify-center font-black uppercase shadow-md">
          ...
          {/* Review Form */}
          <div className="bg-white rounded-[2rem] border border-gray-100 shadow-xl p-6 sm:p-8 h-fit lg:sticky lg:top-24">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Help other customers understand this product better.
            </p>
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-5">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-gray-200 rounded-2xl px-4 py-3 text-sm font-bold text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-gray-200 rounded-2xl px-4 py-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 resize-none"
                />
              </div>
              ...
              <button
                ...
                className={`w-full inline-flex items-center justify-center gap-2 px-4 py-4 rounded-2xl text-sm font-black text-white transition-all ${
                  reviewLoading
                    ? 'bg-gray-400 cursor-not-allowed'
                    : 'bg-indigo-600 hover:bg-indigo-700 hover:-translate-y-0.5 shadow-lg shadow-indigo-100'
                }`}
              >
