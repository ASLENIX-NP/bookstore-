  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        ...
        setError(
          'Unable to process the store repository streams.'
        );
      })
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <select
                ...
                className="bg-slate-50 border border-gray-200 rounded-2xl px-4 py-3 text-sm font-bold text-gray-700"
              >
                <option value="all">
                  All Categories
                </option>
                    ...
                    <div className="pt-4 border-t border-gray-100">
                      ...
                      <div className="flex items-center gap-2 mt-4">
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-3 py-3 rounded-xl text-sm font-black bg-slate-100 text-slate-700"
                        >
                        ...
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center gap-2 px-3 py-3 rounded-xl text-sm font-black ${
                            isOutOfStock
