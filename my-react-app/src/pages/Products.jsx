...
export default function Products() {
  ...
  const categories = [
    ...
    },
    {
      value: 'novels',
      label: 'Novels',
      count: products.filter((p) => p.category === 'novels').length,
    },
    {
      value: 'notebooks',
      label: 'Notebooks',
      count: products.filter((p) => p.category === 'notebooks').length,
    },
    {
      value: 'pens',
      label: 'Pens',
      count: products.filter((p) => p.category === 'pens').length,
    },
    {
      value: 'pencils',
      label: 'Pencils',
      count: products.filter((p) => p.category === 'pencils').length,
    },
    {
      value: 'scales',
      label: 'Scales & Rulers',
      count: products.filter((p) => p.category === 'scales').length,
    },
    {
      value: 'erasers',
      label: 'Erasers',
      count: products.filter((p) => p.category === 'erasers').length,
    },
    {
      value: 'geometry-box',
      label: 'Geometry Box',
      count: products.filter((p) => p.category === 'geometry-box').length,
    },
    {
      value: 'art-supplies',
      label: 'Art Supplies',
      count: products.filter((p) => p.category === 'art-supplies').length,
    },
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Browse our complete stationery collection - {filteredProducts.length}{' '}
          products available
        </p>
      </div>
