        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-gray-500 font-medium transition-all duration-200">
              {isAdmin ? (
                <span className="text-orange-600 flex items-center justify-center gap-1.5 text-xs font-bold uppercase tracking-wider bg-orange-50 p-2 rounded-lg border border-orange-100">
